...
import com.backend.domain.product.entity.StarbucksProduct;
...
@Service("starbucksProductService")
@RequiredArgsConstructor
public class StarbucksProductService implements ProductService {
    ...
    public Product saveProduct(Member actor, ProductCreateRequest request) {
        Product product = new StarbucksProduct(
                request.name(),
                request.description(),
