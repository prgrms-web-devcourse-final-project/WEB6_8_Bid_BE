...
public class ProdInitData {
    ...
    private List<Member> createMembers() {
        ...
        if(memberRepository.findByEmail("admin@test.com").isEmpty()) {
            ...
            members.add(memberRepository.findByEmail("admin@test.com").get());
        }
        ...
        for (int i = 0; i < nicknames.length; i++) {
            if (memberRepository.findByEmail("member" + (i+1) + "@example.com").isEmpty()) {
                members.add(memberRepository.save(Member.builder()
                ...
                members.add(memberRepository.findByEmail("member" + (i+1) + "@example.com").get());
            }
        }
